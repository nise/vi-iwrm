...
//  			this.setOptions(options); 
  		...
  		// defaults
  		options : {selector: '#screen', clockInterval: 500, videoSelector: '#video1', wrapControls:'#container', markupType: 'wiki'},
  		...
  		/*
			setOptions : function(op){
				this.options.selector = op.selector != null ? op.selector : '#screen';	  		
				this.options.clockInterval = op.clockInterval != null ? op.clockInterval : '500';	  		
				this.options.videoSelector = op.videoSelector != null ? op.videoSelector : '#video1';
	  		this.options.markupType = op.markupType != null ? op.markupType : 'wiki';	  		
			},*/
  		...
  		init : function(){
  			...
  			$(this.options.selector)
				...
				this.player = new Video({selector: this.options.videoSelector, wrapControls: this.options.wrapControls}, this);
